...
const About: React.FC = () => {
  return (
    <section
      id="about"
      className="py-24 px-6 md:px-10 bg-[var(--background)] border-t border-[var(--border-slate)]/40"
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="lg:col-span-7 glass-card rounded-3xl p-8 md:p-10 relative overflow-hidden text-[var(--foreground)]/85 space-y-6"
          >
            {/* Subtle glow */}
            ...
            <div className="mt-8 pt-8 border-t border-[var(--border-slate)]/50 flex flex-wrap items-center gap-4 text-[var(--accent-coral)] text-sm font-semibold tracking-wider uppercase">
          ...
          >
            <h3 className="text-2xl font-bold font-heading text-[var(--foreground)] mb-3 pl-1">
            ...
            <div className="flex items-start gap-4 p-5 glass rounded-2xl hover-glow">
              ...
              <div>
                <h4 className="text-lg font-bold font-heading text-[var(--foreground)] mb-1">Robust Backend Architectures</h4>
                <p className="text-sm text-[var(--foreground)]/70">Designing secure API architecture using Java Servlets, JDBC, Node.js, and Express, focusing on session management and token authentications.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-5 glass rounded-2xl hover-glow">
              ...
              <div>
                <h4 className="text-lg font-bold font-heading text-[var(--foreground)] mb-1">Database Optimization</h4>
                <p className="text-sm text-[var(--foreground)]/70">Normalizing relational schemas, indexes creation and transaction isolation locking to mitigate problems associated with concurrency control.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-5 glass rounded-2xl hover-glow">
              ...
              <div>
                <h4 className="text-lg font-bold font-heading text-[var(--foreground)] mb-1">Scalable UI Components</h4>
                <p className="text-sm text-[var(--foreground)]/70">Developing responsive React and Next.js interfaces with optimal render cycles and clean modular state management strategies.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-5 glass rounded-2xl hover-glow">
              ...
              <div>
                <h4 className="text-lg font-bold font-heading text-[var(--foreground)] mb-1">Testing & Quality Assurance</h4>
                <p className="text-sm text-[var(--foreground)]/70">Testing applications using unit testing and integration testing methodologies, ensuring REST APIs are working correctly.</p>
              </div>
            </div>
          </motion.div>
        </div>
