          ...
          >
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-4 gap-2">
              ...
              <div className="flex flex-col md:items-end text-gray-400 text-sm gap-1">
                <span className="flex items-center"><Calendar size={14} className="mr-1" /> Jan 2026 - Jun 2026</span>
  ...
  const education = [
    {
      ...
      year: "2024 - 2026",
      details: "Goal: Data Anslyst, Software Development, Backend Engineering"
    },
    {
    ...
    },
    {
      ...
      school: "Bytco College Nashik (Maharashtra State Board, Pune)",
      year: "2020 - 2021",
      details: "79.83%"
    }
  ];
